...
function sortLayoutItems(layout, compactType, invertSort) {
  if (compactType === "horizontal") return sortLayoutItemsByColRow(layout, invertSort);else return sortLayoutItemsByRowCol(layout, invertSort);
}

function sortLayoutItemsByRowCol(layout, invertSort) {
  return [].concat(layout).sort(function (a, b) {
    var aShouldMove = a.y > b.y || a.y === b.y && (invertSort ? a.x < b.x : a.x > b.x);
    if (aShouldMove) {
      return 1;
